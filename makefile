...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  andGate.o clock.o norGate.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#&
...
#^|
andGate.o: /cygdrive/C/eclipse/workspace/jkclock/andGate.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
clock.o: /cygdrive/C/eclipse/workspace/jkclock/clock.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
norGate.o: /cygdrive/C/eclipse/workspace/jkclock/norGate.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/jkclock/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
andGate.o: /cygdrive/C/eclipse/workspace/jkclock/andGate.cpp \
 /cygdrive/C/eclipse/workspace/jkclock/andGate.h \
...
clock.o: /cygdrive/C/eclipse/workspace/jkclock/clock.cpp \
 /cygdrive/C/eclipse/workspace/jkclock/clock.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
norGate.o: /cygdrive/C/eclipse/workspace/jkclock/norGate.cpp \
 /cygdrive/C/eclipse/workspace/jkclock/norGate.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
